...
import { getSliderTokenStyles, formatSliderValue, getSliderLabelStyles } from "./utils";
import { SliderProps as BaseSliderProps, SliderSize, SliderVariant, SliderLabelPosition } from "./types"

type SliderProps = BaseSliderProps & 
  Omit<React.ComponentProps<typeof SliderPrimitive.Root>, keyof BaseSliderProps>;
