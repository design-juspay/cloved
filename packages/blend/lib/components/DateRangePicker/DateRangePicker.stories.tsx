  ...
  return (
    <div style={{ minHeight: '400px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ 
        ...
        Start: {dateRange.startDate.toLocaleDateString()}<br />
  ...
  return (
    <div style={{ minHeight: '400px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ 
        ...
        Start: {dateRange.startDate.toLocaleString()}<br />
  ...
  return (
    <div style={{ minHeight: '400px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ 
        ...
        <strong>Custom Trigger Selected Range:</strong><br />
        Start: {dateRange.startDate.toLocaleDateString()}<br />
        End: {dateRange.endDate.toLocaleDateString()}
      </div>
    </div>
    ...
    <div style={{ minHeight: '400px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ 
        ...
        {dateRange.startDate.getTime() !== dateRange.endDate.getTime() && (
          <>
            <br />End: {dateRange.endDate.toLocaleDateString()}
            <br /><em>(Range mode - different dates selected)</em>
          </>
        )}
      </div>
    </div>
  ...
  return (
    <div style={{ minHeight: '400px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ 
        ...
        <strong>Selected Range (ISO Format):</strong><br />
        Start: {dateRange.startDate.getFullYear()}-{(dateRange.startDate.getMonth() + 1).toString().padStart(2, '0')}-{dateRange.startDate.getDate().toString().padStart(2, '0')}<br />
        End: {dateRange.endDate.getFullYear()}-{(dateRange.endDate.getMonth() + 1).toString().padStart(2, '0')}-{dateRange.endDate.getDate().toString().padStart(2, '0')}
      </div>
    </div>
  );
};
  ...
  return (
    <div style={{ minHeight: '400px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ 
        ...
        <strong>Disabled State:</strong><br />
        The date picker is disabled and cannot be interacted with.<br />
...
const ComplexIntegrationComponent = (args: Story['args']) => {
  ...
  const handleDateRangeChange = async (newRange: DateRange) => {
    ...
    const mockData = Array.from({ length: Math.min(days, 30) }, (_, i) => ({
      date: new Date(newRange.startDate.getTime() + i * 24 * 60 * 60 * 1000).toLocaleDateString(),
  ...
  return (
    <div style={{ minHeight: '500px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
      <div style={{
        padding: '20px',
        ...
        <p style={{ margin: '0 0 20px 0', color: '#6b7280', fontSize: '14px' }}>
          Select a date range to load analytics data. This example shows how to integrate 
          the DateRangePicker with data fetching and loading states.
        </p>
      ...
      <div style={{ 
        ...
        This shows how to integrate DateRangePicker with data fetching, loading states, 
        and custom trigger styling for dashboard-like applications.
      </div>
    </div>
  );
};
