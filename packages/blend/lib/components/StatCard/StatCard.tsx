  ...
  const formattedChange = change ? (
    <Block display="flex" alignItems="center">
      {change.type === ChangeType.INCREASE ? (
        <ArrowUp
          size={parseInt(
            statCardToken.stats.change.arrow.width?.toString() || "14"
          )}
            ...
            >
              ...
              >
                <Text
                  ...
                  variant="body.md"
                  fontWeight={
                    statCardToken.header.title[effectiveVariant].fontWeight
                  }
            ...
            >
              ...
              >
                <Text
                  ...
                  variant="heading.lg"
                  fontWeight={
                    statCardToken.stats.value[effectiveVariant].fontWeight
                  }
              ...
              <Text
                ...
                fontWeight={
                  statCardToken.stats.subtitle[effectiveVariant].fontWeight
                }
              >
                {subtitle}
              </Text>
              ...
              {helpIconText && (
                ...
                >
                  <Tooltip content={helpIconText}>
                    <CircleHelp
                      width={parseInt(
                        statCardToken.header.helpIcon.width?.toString() || "16"
                      )}
                      height={parseInt(
                        statCardToken.header.helpIcon.height?.toString() || "16"
                      )}
                      color={statCardToken.header.helpIcon.color}
                    />
                  </Tooltip>
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <RechartsTooltip
                  ...
                  cursor={{
                    strokeDasharray:
                      statCardToken.chart.tooltip.cursor.strokeDasharray,
                ...
                <defs>
                  <linearGradient id={gradientId} x1="0" y1="0" x2="0" y2="1">
                    ...
                    <stop
                      ...
                      stopOpacity={
                        statCardToken.chart.colors.gradient.endOpacity
                      }
                    />
                  </linearGradient>
                </defs>
            ...
            progressValue && (
              ...
              >
                ...
                >
                  <Block
                    backgroundColor={
                      statCardToken.chart.progressBar.background.fill
                    }
                    height="100%"
                    width={`${progressValue}%`}
                  />
                  <Block
                    backgroundColor={
                      statCardToken.chart.progressBar.background.empty
                    }
                    height="100%"
                    ...
                    backgroundSize={
                      statCardToken.chart.progressBar.background.pattern.size
                    }
