...
const layout = ({ children }: { children: React.ReactNode }) => {
  return (
    <main className="w-screen h-screen relative">
      <div className="fixed top-0 left-0 right-0 h-[var(--default-navbar-height)] z-10  bg-background flex items-center justify-center px-6">
      ...
      <div className="w-screen flex h-screen">
        <div className="max-w-7xl mx-auto w-full flex debug">
          <aside
            className="min-w-[16rem] h-screen px-4"
