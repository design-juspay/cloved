...
<DocsTypeTable
  data={[
    [
      { content: "primaryTag", hintText: "The primary tag configuration" },
      { content: "TagConfig", hintText: "object" },
      { content: "Required" },
    ],
    [
      { content: "secondaryTag", hintText: "The secondary tag configuration (optional)" },
      { content: "TagConfig", hintText: "object" },
      { content: "Optional" },
    ],
    [
      { content: "leadingSlot", hintText: "Content to display before the tags" },
      { content: "ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "trailingSlot", hintText: "Content to display after the tags" },
      { content: "ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
...
### Split Tag with Different Sizes
Split tag with medium size and rounded shape
