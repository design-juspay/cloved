...
<DocsTypeTable
  data={[
    [
      { content: "title", hintText: "The title text displayed in the stat card" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "value", hintText: "The main value displayed in the stat card" },
      { content: "string | number", hintText: "union type" },
      { content: "" },
    ],
    [
      { content: "change", hintText: "Change indicator showing percentage increase or decrease" },
      { content: "StatCardChange", hintText: "object" },
      { content: "" },
    ],
    [
      { content: "subtitle", hintText: "Secondary text displayed below the main value" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "variant", hintText: "The visual variant of the stat card" },
      { content: "StatCardVariant", hintText: "enum" },
      { content: "" },
    ],
    [
      { content: "chartData", hintText: "Data points for line and bar chart variants" },
      { content: "ChartDataPoint[]", hintText: "array" },
      { content: "" },
    ],
    [
      { content: "progressValue", hintText: "Progress percentage for progress bar variant (0-100)" },
      { content: "number", hintText: "number" },
      { content: "" },
    ],
    [
      { content: "titleIcon", hintText: "Icon element displayed next to the title" },
      { content: "React.ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "actionIcon", hintText: "Icon element displayed on the right side of the header" },
      { content: "React.ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "helpIconText", hintText: "Tooltip text for the help icon" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
  ]}
...
<DocsTypeTable
  data={[
    ...
    [
      { content: "type", hintText: "Whether the change is an increase or decrease" },
...
<DocsTypeTable
  data={[
    [
      { content: "value", hintText: "The numeric value for the data point" },
      { content: "number", hintText: "number" },
      { content: "" },
    ],
    [
    ...
    [
      { content: "date", hintText: "Optional date string for the data point" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
  ]}
