...
<DocsTypeTable
  data={[
    [
      { content: "defaultValue", hintText: "The default selected tab value" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "value", hintText: "The currently selected tab value (controlled)" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "onValueChange", hintText: "Callback when tab selection changes" },
      { content: "(value: string) => void", hintText: "function" },
      { content: "" },
    ],
    [
      { content: "variant", hintText: "The visual style variant of the tabs" },
...
<DocsTypeTable
  data={[
    [
      { content: "variant", hintText: "The visual style variant of the tabs list" },
      { content: "TabsVariant", hintText: "enum" },
      { content: "TabsVariant.UNDERLINE" },
    ],
    [
    ...
    [
      { content: "expanded", hintText: "Whether tabs should expand to fill available width" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "fitContent", hintText: "Whether tabs should fit their content width" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
  ]}
...
<DocsTypeTable
  data={[
    [
      { content: "value", hintText: "The unique value for this tab trigger" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "variant", hintText: "The visual style variant of the tab trigger" },
      { content: "TabsVariant", hintText: "enum" },
      { content: "TabsVariant.UNDERLINE" },
    ],
    [
    ...
    [
      { content: "leftSlot", hintText: "Icon or element to display before the tab text" },
      { content: "React.ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "rightSlot", hintText: "Icon or element to display after the tab text" },
      { content: "React.ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "children", hintText: "The text content of the tab trigger" },
...
<DocsTypeTable
  data={[
    [
      { content: "value", hintText: "The value that matches the corresponding TabsTrigger" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "children", hintText: "The content to display when this tab is active" },
      { content: "React.ReactNode", hintText: "React node" },
      { content: "" },
    ],
  ]}
...
<Tabs defaultValue="dashboard">
  <TabsList variant={TabsVariant.FLOATING}>
    ...
    <TabsTrigger value="users" leftSlot={<UsersIcon />} rightSlot={<Badge>3</Badge>}>
      Users
    </TabsTrigger>
