...
<DocsTypeTable
  data={[
    [
      { content: "id", hintText: "Unique identifier for the radio button" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "value", hintText: "The value associated with the radio button" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "checked", hintText: "Whether the radio button is selected" },
    ...
    [
      { content: "onChange", hintText: "Callback when the radio button state changes" },
      { content: "(checked: boolean) => void", hintText: "function" },
      { content: "" },
    ],
    [
      { content: "disabled", hintText: "Whether the radio button is disabled and non-interactive" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "required", hintText: "Whether the radio button is required (shows asterisk)" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "error", hintText: "Whether the radio button is in an error state" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "size", hintText: "The size variant of the radio button" },
      { content: "RadioSize", hintText: "enum" },
      { content: "RadioSize.MEDIUM" },
    ],
    [
      { content: "children", hintText: "The label text for the radio button" },
...
<DocsTypeTable
  data={[
    [
      { content: "id", hintText: "Unique identifier for the radio group" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "label", hintText: "The label text for the radio group" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "name", hintText: "The name attribute for the radio group (required)" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "defaultValue", hintText: "The default selected value for uncontrolled usage" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
    ...
    [
      { content: "onChange", hintText: "Callback when the selected value changes" },
      { content: "(value: string) => void", hintText: "function" },
      { content: "" },
    ],
    [
      { content: "disabled", hintText: "Whether all radio buttons in the group are disabled" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
  ]}
