...
<DocsTypeTable
  data={[
    ...
    [
      { content: "value", hintText: "The value associated with the checkbox" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "checked", hintText: "The checked state of the checkbox" },
      { content: "boolean | 'indeterminate'", hintText: "boolean or string" },
      { content: "" },
    ],
    [
    ...
    [
      { content: "onCheckedChange", hintText: "Callback when the checkbox state changes" },
      { content: "(checked: boolean | 'indeterminate') => void", hintText: "function" },
      { content: "" },
    ],
    [
      { content: "disabled", hintText: "Whether the checkbox is disabled and non-interactive" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "required", hintText: "Whether the checkbox is required (shows asterisk)" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "error", hintText: "Whether the checkbox is in an error state" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
    ...
    [
      { content: "children", hintText: "The label text for the checkbox" },
