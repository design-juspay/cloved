...
<DocsTypeTable
  data={[
    ...
    [
      { content: "colors", hintText: "Array of colors for chart elements" },
      { content: "string[]", hintText: "array" },
      { content: "DEFAULT_COLORS" },
    ],
    [
      { content: "metrics", hintText: "Array of metric names to display" },
      { content: "string[]", hintText: "array" },
      { content: "" },
    ],
    [
    ...
    [
      { content: "legendPosition", hintText: "Position of the chart legend" },
      { content: "ChartLegendPosition", hintText: "enum" },
      { content: "ChartLegendPosition.TOP" },
    ],
    [
      { content: "chartHeaderSlot", hintText: "Main header content for the chart" },
      { content: "ReactNode", hintText: "React node" },
      { content: "required" },
    ],
  ]}
...
type DataPoint = {
  ...
  aux?: {          // Optional auxiliary data points
    label: string;
    val: number;
  }[];
};
