...
<DocsTypeTable
  data={[
    ...
    [
      { content: "accordionType", hintText: "The visual style variant of the accordion" },
      { content: "AccordionType", hintText: "enum" },
      { content: "AccordionType.NO_BORDER" },
    ],
    [
      { content: "defaultValue", hintText: "The default value(s) for the accordion" },
      { content: "string | string[]", hintText: "string or array" },
      { content: "" },
    ],
    [
      { content: "value", hintText: "The controlled value(s) for the accordion" },
      { content: "string | string[]", hintText: "string or array" },
      { content: "" },
    ],
    [
      { content: "isMultiple", hintText: "Whether multiple items can be expanded simultaneously" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "onValueChange", hintText: "Callback when the accordion value changes" },
      { content: "(value: string | string[]) => void", hintText: "function" },
      { content: "" },
    ],
  ]}
  className="mb-8"
...
<DocsTypeTable
  data={[
    [
      { content: "value", hintText: "Unique identifier for the accordion item" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "title", hintText: "The title text displayed in the accordion trigger" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "children", hintText: "The content to display when the accordion item is expanded" },
      { content: "ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "subtext", hintText: "Optional subtitle text displayed below the title" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "leftSlot", hintText: "Optional element to display on the left side of the trigger" },
      { content: "ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "rightSlot", hintText: "Optional element to display on the right side of the trigger" },
      { content: "ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "subtextSlot", hintText: "Optional element to display alongside the subtext" },
      { content: "ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "isDisabled", hintText: "Whether the accordion item is disabled and non-interactive" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "chevronPosition", hintText: "Position of the chevron icon relative to the trigger" },
      { content: "AccordionChevronPosition", hintText: "enum" },
      { content: "AccordionChevronPosition.RIGHT" },
    ],
    [
      { content: "className", hintText: "Additional CSS class name for the accordion item" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
  ]}
...
<Accordion accordionType={AccordionType.BORDER}>
  <AccordionItem value="item-1" title="What is Blend Design System?">
    <p>Blend is a comprehensive design system that provides reusable components.</p>
  </AccordionItem>
...
<Accordion accordionType={AccordionType.BORDER}>
  ...
  >
    <p>Access comprehensive documentation with examples and API references.</p>
  </AccordionItem>
  <AccordionItem 
    value="item-2" 
    title="Components"
