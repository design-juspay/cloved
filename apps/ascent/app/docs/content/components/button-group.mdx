...
<DocsTypeTable
  ...
  data={[
    [
      { content: "stacked", hintText: "Whether buttons should be stacked or side by side" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "children", hintText: "ButtonV2 components to be grouped together" },
      { content: "ReactElement<ButtonV2Props> | ReactElement<ButtonV2Props>[]", hintText: "React elements" },
      { content: "" },
    ],
  ]}
  isHoverable={true}
