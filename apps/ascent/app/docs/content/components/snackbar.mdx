...
<DocsTypeTable
  data={[
    [
      { content: "No props", hintText: "The Snackbar component is a container that renders toast notifications" },
...
<DocsTypeTable
  data={[
    [
      { content: "header", hintText: "The main title text displayed in the snackbar" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "description", hintText: "Optional descriptive text displayed below the header" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "variant", hintText: "The visual style variant of the snackbar" },
      { content: "SnackbarVariant", hintText: "enum" },
      { content: "SnackbarVariant.INFO" },
    ],
    [
      { content: "onClose", hintText: "Callback function called when the snackbar is closed" },
      { content: "() => void", hintText: "function" },
      { content: "" },
    ],
    [
      { content: "actionButton", hintText: "Optional action button configuration" },
      { content: "{ label: string; onClick: () => void }", hintText: "object" },
      { content: "" },
    ],
  ]}
  className="mb-8"
...
const showDetailedSnackbar = () => {
  addSnackbar({
    ...
    description: "Your document has been successfully uploaded to the cloud.",
    variant: SnackbarVariant.SUCCESS,
  });
};
```
