...
<DocsTypeTable
  data={[
    [
      { content: "heading", hintText: "The main title text displayed in the popover header" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "description", hintText: "Optional descriptive text displayed below the heading" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "trigger", hintText: "The element that triggers the popover to open" },
      { content: "ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "children", hintText: "The content to display inside the popover" },
      { content: "ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "showCloseButton", hintText: "Whether to show the close button in the header" },
      { content: "boolean", hintText: "boolean" },
      { content: "true" },
    ],
    [
      { content: "onOpenChange", hintText: "Callback when the popover open state changes" },
      { content: "(open: boolean) => void", hintText: "function" },
      { content: "" },
    ],
    [
      { content: "open", hintText: "Controlled state for the popover visibility" },
      { content: "boolean", hintText: "boolean" },
      { content: "" },
    ],
    [
      { content: "asModal", hintText: "Whether the popover should behave as a modal" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "primaryAction", hintText: "Configuration for the primary action button" },
      { content: "PopoverActionType", hintText: "object" },
      { content: "" },
    ],
    [
      { content: "secondaryAction", hintText: "Configuration for the secondary action button" },
      { content: "PopoverActionType", hintText: "object" },
      { content: "" },
    ],
    [
      { content: "sideOffset", hintText: "Distance between the popover and trigger element" },
      { content: "number", hintText: "number" },
      { content: "8" },
    ],
    [
      { content: "side", hintText: "The side of the trigger where the popover appears" },
      { content: "'top' | 'right' | 'bottom' | 'left'", hintText: "union type" },
      { content: "bottom" },
    ],
    [
      { content: "align", hintText: "The alignment of the popover relative to the trigger" },
      { content: "'start' | 'center' | 'end'", hintText: "union type" },
      { content: "center" },
    ],
    [
      { content: "alignOffset", hintText: "Offset for the alignment position" },
      { content: "number", hintText: "number" },
      { content: "0" },
    ],
    [
    ...
    [
      { content: "onClose", hintText: "Callback function called when the popover is closed" },
...
```tsx
<Popover
  trigger={<button>Open Content Only</button>}
