...
<DocsTypeTable
  data={[
    [
      { content: "label", hintText: "The label text for the select component" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "subLabel", hintText: "Optional sub-label text displayed below the main label" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "hintText", hintText: "Optional hint text displayed below the select" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "required", hintText: "Whether the select is required (shows asterisk)" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "helpIconText", hintText: "Optional help text displayed with an info icon" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "placeholder", hintText: "The placeholder text when no option is selected" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "size", hintText: "The size variant of the select component" },
      { content: "SelectMenuSize", hintText: "enum" },
      { content: "SelectMenuSize.MEDIUM" },
    ],
    [
      { content: "items", hintText: "Array of menu groups containing selectable items" },
      { content: "SelectMenuGroupType[]", hintText: "array" },
      { content: "" },
    ],
    [
      { content: "variant", hintText: "The visual variant of the select component" },
    ...
    [
      { content: "onSelect", hintText: "Callback when a value is selected" },
      { content: "(value: string) => void", hintText: "function" },
      { content: "" },
    ],
    [
      { content: "enableSearch", hintText: "Whether to enable search functionality in the dropdown" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "slot", hintText: "Optional element to display alongside the trigger" },
      { content: "ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "disabled", hintText: "Whether the select is disabled and non-interactive" },
      { content: "boolean", hintText: "boolean" },
      { content: "false" },
    ],
    [
      { content: "name", hintText: "The name attribute for form integration" },
      { content: "string", hintText: "string" },
      { content: "" },
    ],
    [
      { content: "alignment", hintText: "The alignment of the dropdown menu relative to the trigger" },
      { content: "SelectMenuAlignment", hintText: "enum" },
      { content: "SelectMenuAlignment.CENTER" },
    ],
    [
      { content: "side", hintText: "The side where the dropdown menu appears" },
      { content: "SelectMenuSide", hintText: "enum" },
      { content: "SelectMenuSide.BOTTOM" },
    ],
    [
      { content: "sideOffset", hintText: "The offset distance from the trigger" },
      { content: "number", hintText: "number" },
      { content: "8" },
    ],
    [
      { content: "alignOffset", hintText: "The offset distance for alignment" },
      { content: "number", hintText: "number" },
      { content: "0" },
    ],
    [
      { content: "minWidth", hintText: "The minimum width of the dropdown menu" },
      { content: "number", hintText: "number" },
      { content: "" },
    ],
    [
      { content: "maxWidth", hintText: "The maximum width of the dropdown menu" },
      { content: "number", hintText: "number" },
      { content: "" },
    ],
    [
      { content: "maxHeight", hintText: "The maximum height of the dropdown menu" },
      { content: "number", hintText: "number" },
      { content: "" },
    ],
  ]}
...
const categories = [
  {
    ...
    items: [
      { label: "Web Development", value: "web-dev", subLabel: "HTML, CSS, JavaScript" },
      { label: "Mobile Development", value: "mobile-dev", subLabel: "iOS, Android, React Native" },
      { label: "Data Science", value: "data-science", subLabel: "Python, R, Machine Learning" },
    ],
  },
];
