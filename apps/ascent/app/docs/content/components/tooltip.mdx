...
<DocsTypeTable
  data={[
    [
      { content: "children", hintText: "The trigger element that will show the tooltip on hover/focus" },
      { content: "ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "content", hintText: "The content to display in the tooltip" },
      { content: "ReactNode | string", hintText: "React node or string" },
      { content: "" },
    ],
    [
      { content: "side", hintText: "The side of the trigger element where the tooltip appears" },
      { content: "TooltipSide", hintText: "enum" },
      { content: "TooltipSide.TOP" },
    ],
    [
      { content: "align", hintText: "The alignment of the tooltip relative to the trigger element" },
      { content: "TooltipAlign", hintText: "enum" },
      { content: "TooltipAlign.CENTER" },
    ],
    [
      { content: "showArrow", hintText: "Whether to show the arrow pointing to the trigger element" },
    ...
    [
      { content: "slot", hintText: "Optional icon or element to display alongside the tooltip content" },
      { content: "ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "slotDirection", hintText: "The position of the slot relative to the tooltip content" },
      { content: "TooltipSlotDirection", hintText: "enum" },
      { content: "TooltipSlotDirection.LEFT" },
    ],
    [
      { content: "delayDuration", hintText: "Delay in milliseconds before showing the tooltip" },
      { content: "number", hintText: "number" },
      { content: "300" },
    ],
    [
      { content: "offset", hintText: "Distance between the tooltip and the trigger element" },
      { content: "number", hintText: "number" },
      { content: "5" },
    ],
    [
      { content: "open", hintText: "Controlled state for showing/hiding the tooltip" },
      { content: "boolean", hintText: "boolean" },
      { content: "" },
    ],
  ]}
