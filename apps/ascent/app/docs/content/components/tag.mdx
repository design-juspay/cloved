...
<DocsTypeTable
  ...
  data={[
    [
      { content: "text", hintText: "The text content displayed in the tag" },
    ...
    [
      { content: "shape", hintText: "The border radius shape of the tag" },
      { content: "TagShape", hintText: "enum" },
      { content: "SQUARICAL" },
    ],
    [
      { content: "leftSlot", hintText: "Content displayed before the text" },
      { content: "React.ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
      { content: "rightSlot", hintText: "Content displayed after the text" },
      { content: "React.ReactNode", hintText: "React node" },
      { content: "" },
    ],
    [
    ...
    [
      { content: "splitTagPosition", hintText: "Position for split tag styling" },
