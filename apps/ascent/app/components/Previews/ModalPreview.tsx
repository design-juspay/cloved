      ...
      <div className="m-4 space-y-4">
        ...
        <div>
          ...
          >
            <div className="space-y-4">
              <p className="text-gray-600">
                This modal demonstrates the footer with action buttons.
              </p>
              <div className="bg-yellow-50 p-3 rounded border border-yellow-200">
                <p className="text-sm text-yellow-800">
                  <strong>Note:</strong> The footer automatically appears when you provide primaryAction or secondaryAction props.
                </p>
              </div>
            </div>
          </Modal>
        ...
        <div>
          ...
          >
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                This modal has no header, no footer, and no close button.
                You'll need to implement your own close mechanism.
              </p>
              <button
