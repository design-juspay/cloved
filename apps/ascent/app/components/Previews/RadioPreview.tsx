  ...
  return (
    ...
    >
      <div className="m-4 min-w-100 space-y-8">
        {/* Basic Radio Group */}
        <div>
          <h3 className="text-lg font-semibold mb-4">Basic Radio Group</h3>
          <RadioGroup
            name="basic-options"
            value={selectedOption}
            onChange={setSelectedOption}
        ...
        {/* Radio with Subtext */}
        <div>
          <h3 className="text-lg font-semibold mb-4">Radio with Subtext</h3>
          <RadioGroup
        ...
        {/* Radio with Slots */}
        <div>
          <h3 className="text-lg font-semibold mb-4">Radio with Slots</h3>
          <RadioGroup
            name="slot-options"
            value={selectedTheme}
        ...
        <div>
          ...
          <div className="p-4 border rounded-lg">
            <h4 className="font-medium text-gray-900 mb-3">Subscription Plan</h4>
            ...
            >
              ...
              <Radio 
                ...
                slot={<span className="text-purple-500 text-sm">Custom</span>}
              >
                Enterprise Plan
              </Radio>
            </RadioGroup>
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4">Disabled Radio Group</h3>
          <RadioGroup
            name="disabled-group"
            value={selectedOption}
            onChange={setSelectedOption}
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4">Individual Radio Controls</h3>
          <div className="space-y-4">
            <Radio 
              value="individual1" 
              name="individual"
              checked={selectedOption === "individual1"}
              onChange={(checked) => checked && setSelectedOption("individual1")}
            >
              Individual Radio 1
            </Radio>
            ...
            <Radio 
              ...
              onChange={(checked) => checked && setSelectedOption("individual2")}
