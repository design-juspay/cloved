...
const SwitchPreview = () => {
  ...
  const [selectedFeatures, setSelectedFeatures] = useState<string[]>(["feature1", "feature3"]);
  const [emailSettings, setEmailSettings] = useState<string[]>(["marketing", "updates"]);
  ...
  return (
    ...
    >
      <div className="m-4 min-w-100 space-y-8">
        ...
        {/* Switch with Subtext */}
        <div>
          <h3 className="text-lg font-semibold mb-4">Switch with Subtext</h3>
          <Switch
            checked={darkMode}
        ...
        {/* Switch with Slot */}
        <div>
          <h3 className="text-lg font-semibold mb-4">Switch with Slot</h3>
          <Switch
            checked={autoSave}
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4">Complex Form Example</h3>
          <div className="p-4 border rounded-lg">
            ...
            >
              ...
              <Switch 
                ...
                slot={<span className="text-green-500 text-sm">Important</span>}
              />
              ...
              <Switch 
                ...
                slot={<span className="text-red-500 text-sm">Critical</span>}
              />
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4">Disabled Switch Group</h3>
          <SwitchGroup
        ...
        {/* Individual Switches */}
        <div>
          <h3 className="text-lg font-semibold mb-4">Individual Switches</h3>
          <div className="space-y-4">
            <Switch
              checked={notifications}
              onChange={setNotifications}
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <h4 className="font-medium mb-2">Uncontrolled Switch</h4>
              <Switch
                defaultChecked={true}
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4">Switch with Different Content</h3>
          <div className="space-y-4">
            <Switch
              checked={true}
              onChange={() => {}}
