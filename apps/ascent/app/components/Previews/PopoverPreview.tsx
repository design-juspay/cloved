  ...
  return (
    ...
    >
      <div className="m-4 min-w-100 space-y-8">
          ...
          >
            <div className="p-4">
              <p className="text-gray-700">
                This is the content area of the popover. You can put any content here.
              </p>
            </div>
          </Popover>
        </div>
        ...
        {/* Small Popover */}
        <div>
          <h3 className="text-lg font-semibold mb-4">Small Popover</h3>
          <Popover
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4">Popover without Actions</h3>
          <Popover
            heading="Information"
          ...
          >
            <div className="p-4">
              <p className="text-gray-700">
                This popover is for informational purposes only. It has no action buttons.
              </p>
            </div>
          </Popover>
        </div>
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4">Custom Positioning</h3>
          <Popover
          ...
          >
            <div className="p-4">
              <p className="text-gray-700">
                This popover is positioned on top of the trigger element.
              </p>
            </div>
          </Popover>
        </div>
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4">Rich Content Popover</h3>
          <Popover
            heading="Settings"
