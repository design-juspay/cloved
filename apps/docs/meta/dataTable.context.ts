...
enum SortDirection {
  ...
  },
  {
    ...
    llmContext: "Whether search is handled server-side (disables local search)",
    propDefault: "false",
  },
  {
  ...
  },
  {
    ...
    llmContext: "Whether data is currently being loaded (shows loading states)",
    propDefault: "false",
  },
  {
  ...
  },
  {
    ...
    llmContext: "Optional function to determine if a row should be expandable",
    propDefault: "-",
  },
  {
    propName: "pagination",
