      ...
      <>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
            ...
            <div>
              <p style={{ margin: 0, fontWeight: '500' }}>Are you sure you want to delete this item?</p>
    ...
    const customHeader = (
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <Star size={24} />
          <div>
            <h2 style={{ margin: 0, fontSize: '18px', fontWeight: '600' }}>Premium Features</h2>
            <p style={{ margin: 0, fontSize: '14px', opacity: 0.9 }}>Unlock advanced capabilities</p>
          </div>
        </div>
        <Button
        ...
        >
          <div style={{ lineHeight: '1.6' }}>
            <p>
              ...
              It was developed by Facebook and is now maintained by Meta and the open-source community.
            </p>
            <p>
              One of React's key features is its component-based architecture, which allows developers to 
              build encapsulated components that manage their own state and compose them to make complex UIs.
            </p>
            <p>
              React uses a virtual DOM to efficiently update the user interface, making applications fast 
              and responsive even with complex state changes.
            </p>
          </div>
        </Modal>
      </>
    ...
    return (
      <>
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div>
              <h4 style={{ margin: '0 0 12px 0', fontSize: '16px', fontWeight: '600' }}>Preferences</h4>
            ...
            <div>
              <h4 style={{ margin: '0 0 12px 0', fontSize: '16px', fontWeight: '600' }}>Language</h4>
              <select 
