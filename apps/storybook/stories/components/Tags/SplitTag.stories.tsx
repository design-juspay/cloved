...
\`\`\`
  ...
  argTypes: {
    ...
    leadingSlot: {
      control: false,
      description: 'Leading slot content (currently not used in implementation)',
    },
    trailingSlot: {
      control: false,
      description: 'Trailing slot content (currently not used in implementation)',
    },
  },
  tags: ['autodocs'],
};
...
export const Interactive: Story = {
  render: () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        <h3 style={{ fontSize: '14px', color: '#666' }}>Click to Select Environment</h3>
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          {environments.map(env => (
            <SplitTag
              ...
              secondaryTag={{ 
                text: env,
                color: selectedEnv === env ? TagColor.SUCCESS : TagColor.NEUTRAL,
...
export const RealWorldExamples: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div>
        <h3 style={{ marginBottom: '12px', fontSize: '16px', fontWeight: 'bold' }}>Software Version Info</h3>
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          <SplitTag
            primaryTag={{ text: 'Version', color: TagColor.NEUTRAL }}
          ...
          <SplitTag
            ...
            secondaryTag={{ text: 'Stable', color: TagColor.SUCCESS, leftSlot: <Check size={12} /> }}
          />
        </div>
      </div>

      <div>
        <h3 style={{ marginBottom: '12px', fontSize: '16px', fontWeight: 'bold' }}>Server Monitoring</h3>
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          <SplitTag
            primaryTag={{ text: 'CPU', color: TagColor.NEUTRAL, leftSlot: <Cpu size={12} /> }}
            secondaryTag={{ text: '45%', color: TagColor.SUCCESS }}
          />
          <SplitTag
            primaryTag={{ text: 'Memory', color: TagColor.NEUTRAL, leftSlot: <Database size={12} /> }}
            secondaryTag={{ text: '78%', color: TagColor.WARNING }}
          />
          <SplitTag
            primaryTag={{ text: 'Disk', color: TagColor.NEUTRAL, leftSlot: <Server size={12} /> }}
      ...
      <div>
        <h3 style={{ marginBottom: '12px', fontSize: '16px', fontWeight: 'bold' }}>E-commerce Order Status</h3>
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          <SplitTag
          ...
          <SplitTag
            primaryTag={{ text: 'Status', color: TagColor.NEUTRAL }}
            secondaryTag={{ text: 'Shipped', color: TagColor.SUCCESS, leftSlot: <Package size={12} /> }}
          />
          <SplitTag
            primaryTag={{ text: 'Payment', color: TagColor.NEUTRAL, leftSlot: <DollarSign size={12} /> }}
            secondaryTag={{ text: 'Paid', color: TagColor.SUCCESS, leftSlot: <Check size={12} /> }}
          />
        </div>
      </div>

      <div>
        <h3 style={{ marginBottom: '12px', fontSize: '16px', fontWeight: 'bold' }}>Project Management</h3>
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          <SplitTag
            primaryTag={{ text: 'Sprint', color: TagColor.NEUTRAL, leftSlot: <Calendar size={12} /> }}
            secondaryTag={{ text: 'Week 3', color: TagColor.PRIMARY }}
          />
          <SplitTag
            primaryTag={{ text: 'Progress', color: TagColor.NEUTRAL, leftSlot: <Activity size={12} /> }}
            secondaryTag={{ text: '75%', color: TagColor.WARNING }}
          />
          <SplitTag
            primaryTag={{ text: 'Due', color: TagColor.NEUTRAL, leftSlot: <Clock size={12} /> }}
...
export const ColorCombinations: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <h3 style={{ marginBottom: '8px', fontSize: '14px', color: '#666' }}>Various Color Combinations</h3>
      <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
        <SplitTag
          primaryTag={{ text: 'Type', color: TagColor.NEUTRAL }}
...
export const ComprehensiveShowcase: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      <div>
        <h3 style={{ marginBottom: '16px', fontSize: '18px', fontWeight: 'bold' }}>SplitTag Component Showcase</h3>
        <p style={{ marginBottom: '24px', color: '#666' }}>
          A comprehensive display of split tag variations and use cases for displaying key-value information.
        </p>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <SplitTag
              ...
              secondaryTag={{ text: 'Operational', color: TagColor.SUCCESS, leftSlot: <Check size={12} /> }}
              size={TagSize.SM}
            />
            <SplitTag
              primaryTag={{ text: 'Database', color: TagColor.NEUTRAL }}
              secondaryTag={{ text: 'Degraded', color: TagColor.WARNING, leftSlot: <AlertCircle size={12} /> }}
              size={TagSize.SM}
            />
            <SplitTag
              primaryTag={{ text: 'CDN', color: TagColor.NEUTRAL }}
              secondaryTag={{ text: 'Offline', color: TagColor.ERROR, leftSlot: <X size={12} /> }}
              size={TagSize.SM}
            />
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <h4 style={{ marginBottom: '12px', fontSize: '14px', fontWeight: 'bold' }}>Performance Metrics</h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <SplitTag
              primaryTag={{ text: 'Score', color: TagColor.NEUTRAL, leftSlot: <Award size={12} /> }}
              secondaryTag={{ text: 'A+', color: TagColor.SUCCESS }}
              size={TagSize.SM}
            />
            <SplitTag
              primaryTag={{ text: 'Speed', color: TagColor.NEUTRAL, leftSlot: <Activity size={12} /> }}
              secondaryTag={{ text: '1.2s', color: TagColor.PRIMARY }}
              size={TagSize.SM}
            />
            <SplitTag
              primaryTag={{ text: 'Uptime', color: TagColor.NEUTRAL, leftSlot: <TrendingUp size={12} /> }}
        ...
        <div style={{ 
          ...
          <h4 style={{ marginBottom: '12px', fontSize: '14px', fontWeight: 'bold' }}>User Information</h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <SplitTag
              primaryTag={{ text: 'Role', color: TagColor.NEUTRAL, leftSlot: <User size={12} /> }}
              secondaryTag={{ text: 'Admin', color: TagColor.ERROR, leftSlot: <Shield size={12} /> }}
              size={TagSize.SM}
            />
            <SplitTag
              primaryTag={{ text: 'Plan', color: TagColor.NEUTRAL, leftSlot: <Star size={12} /> }}
              secondaryTag={{ text: 'Premium', color: TagColor.WARNING }}
              size={TagSize.SM}
            />
            <SplitTag
              primaryTag={{ text: 'Since', color: TagColor.NEUTRAL, leftSlot: <Calendar size={12} /> }}
        ...
        <div style={{ 
          ...
          <h4 style={{ marginBottom: '12px', fontSize: '14px', fontWeight: 'bold' }}>Pricing Information</h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <SplitTag
              primaryTag={{ text: 'Price', color: TagColor.NEUTRAL, leftSlot: <DollarSign size={12} /> }}
              secondaryTag={{ text: '$99/mo', color: TagColor.PRIMARY }}
              size={TagSize.SM}
            />
            <SplitTag
              primaryTag={{ text: 'Discount', color: TagColor.NEUTRAL, leftSlot: <Percent size={12} /> }}
              secondaryTag={{ text: '20% OFF', color: TagColor.ERROR }}
              size={TagSize.SM}
            />
            <SplitTag
              primaryTag={{ text: 'Billing', color: TagColor.NEUTRAL, leftSlot: <Calendar size={12} /> }}
