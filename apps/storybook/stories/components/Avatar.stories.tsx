...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive playground to test different avatar configurations. Use the controls panel below to experiment with different props.',
      },
    },
  },
};
...
export const Examples: Story = {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
        ...
        <div>
          ...
          <div style={{ color: '#6b7280', fontSize: '14px' }}>Senior Developer</div>
          <div style={{ color: '#10b981', fontSize: '12px' }}>● Online</div>
        </div>
      </div>
      ...
      <div style={{ padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
        <div style={{ display: 'flex', gap: '12px', marginBottom: '12px' }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: '14px', marginTop: '4px' }}>Great work on the new design! Really love the attention to detail.</div>
          </div>
        </div>
        <div style={{ display: 'flex', gap: '12px', paddingLeft: '44px' }}>
          ...
          />
          <div style={{ flex: 1 }}>
            <div style={{ fontWeight: '600', fontSize: '14px' }}>Mike Johnson</div>
            <div style={{ fontSize: '14px', marginTop: '4px' }}>Thanks Sarah! Team effort 🙌</div>
          </div>
        </div>
      </div>
      ...
      {/* Team List */}
      <div style={{ padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
        <div style={{ fontWeight: '600', marginBottom: '16px' }}>Team Members</div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {[
            { name: 'Alex Chen', role: 'Team Lead', online: true, image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=32&h=32&fit=crop&crop=face' },
            { name: 'Emma Davis', role: 'Designer', online: true, image: undefined },
            { name: 'David Brown', role: 'Developer', online: false, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=32&h=32&fit=crop&crop=face' },
          ].map((member, index) => (
            <div key={index} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div style={{ fontSize: '12px', color: member.online ? '#10b981' : '#6b7280' }}>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Real-world examples showing avatars in common UI patterns like profiles, comments, and team lists.',
      },
    },
  },
}; 