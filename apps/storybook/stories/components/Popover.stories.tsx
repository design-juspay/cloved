...
import { Settings, User, Bell, HelpCircle, Info, AlertTriangle, CheckCircle, Edit, Trash2, Plus, Filter, Download, Share } from 'lucide-react';
      ...
      >
        <div style={{ padding: '20px 0' }}>
          <p style={{ 
            ...
            This is the main content area of the popover. You can place any content here,
...
export const PopoverSizes: Story = {
      ...
      >
        <div style={{ padding: '20px 0' }}>
          <p style={{ 
            ...
            Medium popover content with comfortable spacing for more detailed information
            and better readability. Perfect for longer descriptions and content.
          </p>
        </div>
      </Popover>
    </div>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Different popover sizes: small for compact content and medium for more detailed information.',
      },
    },
  },
};
...
export const Positioning: Story = {
  render: () => (
    <div style={{ 
      ...
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.SECONDARY} text="Right" />
        }
      ...
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.SECONDARY} text="Bottom" />
        }
  ...
  parameters: {
    docs: {
      description: {
        story: 'Different positioning options: top, right, bottom, and left relative to the trigger.',
      },
    },
  },
};
...
export const WithActions: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '24px', padding: '100px' }}>
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.PRIMARY} text="Settings" leadingIcon={<Settings size={16} />} />
        }
      ...
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.SECONDARY} text="Profile" leadingIcon={<User size={16} />} />
        }
  ...
  parameters: {
    docs: {
      description: {
        story: 'Popovers with primary and secondary actions for user interaction and form submission.',
      },
    },
  },
};
...
export const ContentVariations: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '24px', padding: '100px', flexWrap: 'wrap' }}>
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.SECONDARY} text="Info" leadingIcon={<Info size={16} />} />
        }
        heading="Information"
      ...
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.SECONDARY} text="Filters" leadingIcon={<Filter size={16} />} />
        }
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                {['Active', 'Inactive', 'Pending'].map((status) => (
                  <label key={status} style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px' }}>
      ...
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.SECONDARY} text="Share" leadingIcon={<Share size={16} />} />
        }
      ...
      >
        <div style={{ padding: '16px 0' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {[
              { icon: <User size={16} />, label: 'Share with team', desc: 'All team members can view' },
              { icon: <Bell size={16} />, label: 'Send notification', desc: 'Notify via email' },
              { icon: <Download size={16} />, label: 'Export data', desc: 'Download as CSV' },
            ].map((option, index) => (
              <button
                key={index}
                style={{
  ...
  parameters: {
    docs: {
      description: {
        story: 'Different content types: information displays, filter forms, and action menus.',
      },
    },
  },
};
...
export const WithoutHeader: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '24px', padding: '100px' }}>
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.SECONDARY} text="Quick Edit" leadingIcon={<Edit size={16} />} />
        }
        ...
        <div style={{ padding: '16px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
              <ButtonV2 buttonType={ButtonTypeV2.SECONDARY} size={ButtonSizeV2.SMALL} text="Cancel" />
              <ButtonV2 buttonType={ButtonTypeV2.PRIMARY} size={ButtonSizeV2.SMALL} text="Save" />
            </div>
          </div>
        </div>
      </Popover>
      ...
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.SECONDARY} text="Quick Actions" leadingIcon={<Plus size={16} />} />
        }
        showCloseButton={false}
        maxWidth={200}
      >
...
export const ModalMode: Story = {
  render: () => (
    <div style={{ padding: '100px' }}>
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.PRIMARY} text="Open Modal Popover" />
        }
      ...
      >
        <div style={{ padding: '16px 0' }}>
          <p style={{ margin: '0 0 16px 0', color: '#64748b' }}>
            When a popover is in modal mode, it prevents interaction with the rest of the page
            until it's closed. This is useful for important confirmations or forms that require
          ...
          <div style={{ 
            ...
            <p style={{ margin: 0, color: '#1d4ed8', fontSize: '14px' }}>
              💡 Try clicking outside this popover - it won't close because it's in modal mode.
            </p>
          </div>
        </div>
      </Popover>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Modal mode prevents interaction with the background until the popover is closed.',
      },
    },
  },
};
...
export const ComplexExample: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '24px', padding: '100px', flexWrap: 'wrap' }}>
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.PRIMARY} text="User Profile" leadingIcon={<User size={16} />} />
        }
        heading="John Doe"
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                ...
                <div style={{ color: '#6b7280', fontSize: '14px' }}>john.doe@company.com</div>
            ...
            <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '16px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ fontSize: '14px', fontWeight: '500' }}>San Francisco, CA</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <span style={{ fontSize: '14px', color: '#6b7280' }}>Joined</span>
                  <span style={{ fontSize: '14px', fontWeight: '500' }}>March 2023</span>
                </div>
              </div>
            </div>

            <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '16px' }}>
              <div style={{ fontSize: '14px', fontWeight: '500', marginBottom: '8px' }}>Recent Activity</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
      ...
      <Popover
        trigger={
          <ButtonV2 buttonType={ButtonTypeV2.SECONDARY} text="Help & Support" leadingIcon={<HelpCircle size={16} />} />
        }
        heading="Need Help?"
  ...
  parameters: {
    docs: {
      description: {
        story: 'Complex examples with rich content, user profiles, and support interfaces.',
      },
    },
  },
};
