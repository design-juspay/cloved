...
import { ButtonGroupV2, ButtonV2, ButtonTypeV2, ButtonSizeV2, ButtonSubTypeV2 } from 'blend-v1';
import { Plus, Download, Settings, Save, X, Edit, Trash2, Search, Copy } from 'lucide-react';
...
\`\`\`
  ...
  argTypes: {
    stacked: {
      control: 'boolean',
      description: 'Whether buttons are stacked together (connected) or have spacing',
    },
  },
  tags: ['autodocs'],
};
...
export const StackedVsNonStacked: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>Stacked (Connected)</h4>
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 text="Save" buttonType={ButtonTypeV2.PRIMARY} />
      ...
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>Non-Stacked (Spaced)</h4>
...
export const ButtonTypes: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>Primary Actions</h4>
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 text="Save" buttonType={ButtonTypeV2.PRIMARY} />
          <ButtonV2 text="Save & Continue" buttonType={ButtonTypeV2.PRIMARY} />
          <ButtonV2 text="Cancel" buttonType={ButtonTypeV2.SECONDARY} />
      ...
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>Mixed Types</h4>
        <ButtonGroupV2 stacked={true}>
      ...
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>All Secondary</h4>
        <ButtonGroupV2 stacked={true}>
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div>
        ...
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 text="Save" buttonType={ButtonTypeV2.PRIMARY} size={ButtonSizeV2.SMALL} />
          <ButtonV2 text="Cancel" buttonType={ButtonTypeV2.SECONDARY} size={ButtonSizeV2.SMALL} />
        </ButtonGroupV2>
      </div>
      ...
      <div>
        ...
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 text="Save" buttonType={ButtonTypeV2.PRIMARY} size={ButtonSizeV2.MEDIUM} />
          <ButtonV2 text="Cancel" buttonType={ButtonTypeV2.SECONDARY} size={ButtonSizeV2.MEDIUM} />
        </ButtonGroupV2>
      </div>
      ...
      <div>
        ...
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 text="Save" buttonType={ButtonTypeV2.PRIMARY} size={ButtonSizeV2.LARGE} />
          <ButtonV2 text="Cancel" buttonType={ButtonTypeV2.SECONDARY} size={ButtonSizeV2.LARGE} />
        </ButtonGroupV2>
      </div>
    </div>
  ),
...
export const WithIcons: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>Action Buttons</h4>
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 
            text="Save" 
      ...
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>CRUD Operations</h4>
        <ButtonGroupV2 stacked={false}>
          <ButtonV2 
            text="Add" 
      ...
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>File Operations</h4>
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 
            text="Download" 
...
export const IconOnlyButtons: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>Toolbar Actions</h4>
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 
      ...
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>Media Controls</h4>
        <ButtonGroupV2 stacked={false}>
          <ButtonV2 
            subType={ButtonSubTypeV2.ICON_ONLY}
...
export const CommonUseCases: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>Form Actions</h4>
        <ButtonGroupV2 stacked={false}>
          <ButtonV2 text="Save" buttonType={ButtonTypeV2.PRIMARY} />
      ...
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>Modal Actions</h4>
        <ButtonGroupV2 stacked={false}>
      ...
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>Filter Options</h4>
        <ButtonGroupV2 stacked={true}>
...
export const ButtonStates: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>Normal State</h4>
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 text="Save" buttonType={ButtonTypeV2.PRIMARY} />
          <ButtonV2 text="Cancel" buttonType={ButtonTypeV2.SECONDARY} />
        </ButtonGroupV2>
      ...
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>With Loading</h4>
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 text="Saving..." buttonType={ButtonTypeV2.PRIMARY} loading={true} />
          <ButtonV2 text="Cancel" buttonType={ButtonTypeV2.SECONDARY} />
        </ButtonGroupV2>
      </div>
      
      <div>
        <h4 style={{ marginBottom: '8px', fontSize: '14px', fontWeight: '600' }}>With Disabled</h4>
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 text="Save" buttonType={ButtonTypeV2.PRIMARY} disabled={true} />
          <ButtonV2 text="Cancel" buttonType={ButtonTypeV2.SECONDARY} />
        </ButtonGroupV2>
      </div>
    </div>
...
export const Showcase: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', padding: '16px' }}>
      <div>
        <h3 style={{ marginBottom: '16px', fontSize: '16px', fontWeight: '600' }}>Layout Options</h3>
      ...
      <div>
        <h3 style={{ marginBottom: '16px', fontSize: '16px', fontWeight: '600' }}>Button Types</h3>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <ButtonGroupV2 stacked={true}>
      ...
      <div>
        <h3 style={{ marginBottom: '16px', fontSize: '16px', fontWeight: '600' }}>With Icons</h3>
        <ButtonGroupV2 stacked={false}>
          <ButtonV2 
            text="Add" 
            leadingIcon={<Plus size={16} />}
      ...
      <div>
        <h3 style={{ marginBottom: '16px', fontSize: '16px', fontWeight: '600' }}>Icon Only</h3>
        <ButtonGroupV2 stacked={true}>
          <ButtonV2 
            subType={ButtonSubTypeV2.ICON_ONLY}
            leadingIcon={<Search size={16} />}
