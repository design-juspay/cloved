      ...
      <Charts
        ...
        chartHeaderSlot={
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <LineChart size={20} />
            <span style={{ fontSize: '18px', fontWeight: 'bold' }}>Revenue Trends</span>
          </div>
        }
        slot1={
    ...
    <div style={{ width: '800px', height: '500px' }}>
      <Charts
        ...
        chartHeaderSlot={
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <BarChart3 size={20} />
            <span style={{ fontSize: '18px', fontWeight: 'bold' }}>Monthly Comparison</span>
          </div>
        }
        slot1={
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
    ...
    <div style={{ width: '600px', height: '500px' }}>
      <Charts
        ...
        chartHeaderSlot={
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <PieChart size={20} />
            <span style={{ fontSize: '18px', fontWeight: 'bold' }}>Sales by Category</span>
          </div>
        }
        slot1={
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
      ...
      <Charts
        ...
        chartHeaderSlot={
          <div>
            ...
            <div style={{ fontSize: '14px', color: '#666' }}>
              • Click legend items to toggle series visibility<br />
              • Hover over legend items to highlight series<br />
